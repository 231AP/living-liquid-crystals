...
public:
    ...
    // Define Constructors ()
    Evolver(System * system_ptr1,Particle pt,Particle PT, LLCParams &params, double time_start_t=0, double time_stop_t=1, double time_step_t=0.001, double time_export_t=0.1, string device_t="cpu", std::string scheme_t="EulerForward", std::string FDMScheme_t="CentralDifferenceO2I"){
