...
// ---------------------------------------------------------------------
struct FFuncFieldAddiPtrs {
    // Function can take additonal fields as arguments.
    Field* f2_ptr=NULL;
    Field* f3_ptr=NULL;
    Field* f4_ptr=NULL;
    ...
    FFuncFieldAddiPtrs(Field* f2_ptr1) {
        f2_ptr=f2_ptr1;
    };

    FFuncFieldAddiPtrs(Field* f2_ptr1, Field* f3_ptr1) {
      f2_ptr=f2_ptr1;
      f3_ptr=f3_ptr1;
    };

  FFuncFieldAddiPtrs(Field* f2_ptr1, Field* f3_ptr1, Field* f4_ptr1) {
      f2_ptr=f2_ptr1;
      f3_ptr=f3_ptr1;
      f4_ptr=f4_ptr1;
    };
...
struct FFuncDef {
    ...
    FFuncFieldAddiPtrs f_func_fa_ptrs;
    ...
    FFuncDef (string f_operator1, Field* field_ptr1, FFuncArgs f_func_args1, FFuncFieldAddiPtrs f_func_fa_ptrs1) {
        f_operator=f_operator1;
        field_ptr=field_ptr1;
        f_func_args=f_func_args1;
	f_func_fa_ptrs=f_func_fa_ptrs1;
    };
};
