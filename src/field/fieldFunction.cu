...
#include "finiteDifferenceCentralO2.h"
    ...
    f_func_map_all=
        {
            ...
            {{"d1x","CentralDifferenceO2"},d1xCO2},
            {{"d1y","CentralDifferenceO2"},d1yCO2},
            {{"d2x","CentralDifferenceO2"},d2xCO2},
            {{"d2y","CentralDifferenceO2"},d2yCO2},
            {{"d1x1y","CentralDifferenceO2"},d1x1yCO2},
            {{"d2x2y","CentralDifferenceO2"},d2x2yCO2},
            {{"laplace","CentralDifferenceO2"},laplaceCO2},
            {{"biLaplace","CentralDifferenceO2"},biLaplaceCO2},
            // Onsite functions            
            {{"1",""},oneF},
            {{"1/f",""},oneOverF},
            {{"sin",""},sinF},
...
void setFFuncMapDev () {
    ...
    f_func_map_all_dev[{"d1x","CentralDifferenceO2"}]=getFFuncDevPtr(&d1xCO2_dev);
    f_func_map_all_dev[{"d1y","CentralDifferenceO2"}]=getFFuncDevPtr(&d1yCO2_dev);
    f_func_map_all_dev[{"d2x","CentralDifferenceO2"}]=getFFuncDevPtr(&d2xCO2_dev);
    f_func_map_all_dev[{"d2y","CentralDifferenceO2"}]=getFFuncDevPtr(&d2yCO2_dev);
    f_func_map_all_dev[{"d1x1y","CentralDifferenceO2"}]=getFFuncDevPtr(&d1x1yCO2_dev);
    f_func_map_all_dev[{"d2x2y","CentralDifferenceO2"}]=getFFuncDevPtr(&d2x2yCO2_dev);
    f_func_map_all_dev[{"laplace","CentralDifferenceO2"}]=getFFuncDevPtr(&laplaceCO2_dev);
    f_func_map_all_dev[{"biLaplace","CentralDifferenceO2"}]=getFFuncDevPtr(&biLaplaceCO2_dev);  
